...
function SoonAvailable() {
  ...
  return (
    <div
      className="w-full max-w-[1280px] mx-auto flex flex-col justify-center items-center gap-2 border-2 border-gray-300 shadow-lg rounded-lg p-10
    tablet:w-[90%] tablet:p-7 tablet:gap-5"
    >
